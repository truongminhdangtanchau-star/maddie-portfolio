        ...
        <div className="contact-card relative overflow-hidden rounded-[2.5rem] border border-pink-200/80 bg-white/75 p-7 shadow-[0_35px_110px_rgba(219,39,119,0.18)] backdrop-blur md:p-12">
          ...
          <div className="grid gap-12 md:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <h2 className="max-w-4xl text-5xl font-semibold leading-[0.98] tracking-[-0.06em] text-[#24151d] md:text-7xl">
              ...
              <div className="rounded-[2rem] border border-pink-200 bg-[#24151d] p-6 text-pink-50 shadow-[0_24px_70px_rgba(36,21,29,0.22)]">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <a
                      href={`mailto:${profile.email}`}
                      className="mt-2 block break-words text-lg text-pink-50"
                    >
                      {profile.email}
                    </a>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-lg text-pink-50">{profile.phone}</p>
                  </div>
                  ...
                  <p className="text-sm leading-6 text-pink-100/55">
                    Available for creative coordination, account support, music
                    campaign operations, and entertainment brand projects.
                  </p>
                </div>
              </div>
            </div>
