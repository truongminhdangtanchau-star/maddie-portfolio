...
export default function Hero() {
  return (
    <section className="hero-stage relative flex min-h-screen items-center overflow-hidden bg-[#fff7fb] px-5 py-28 md:px-8">
      ...
      <div className="pointer-events-none absolute bottom-10 left-8 hidden items-end gap-2 md:flex">
        <span className="hero-bar h-10 w-2 rounded-full bg-pink-300" />
        <span className="hero-bar h-20 w-2 rounded-full bg-rose-300 [animation-delay:120ms]" />
        <span className="hero-bar h-14 w-2 rounded-full bg-fuchsia-300 [animation-delay:240ms]" />
        <span className="hero-bar h-28 w-2 rounded-full bg-pink-400 [animation-delay:360ms]" />
        <span className="hero-bar h-16 w-2 rounded-full bg-rose-300 [animation-delay:480ms]" />
      </div>

      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-14 md:grid-cols-[1.1fr_0.9fr]">
        <div className="hero-reveal">
          <p className="mb-5 text-sm uppercase tracking-[0.35em] text-pink-500">
            {profile.name}
          </p>

          <h1 className="max-w-5xl text-6xl font-semibold uppercase leading-[0.86] tracking-[-0.08em] text-[#24151d] md:text-[8.5rem]">
            Creative
            <br />
            Account
            <br />
          ...
          <p className="mt-8 max-w-2xl text-xl leading-8 text-[#6f4a5d]">
            {profile.intro}
          </p>
        ...
        <div className="hero-card-float relative">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-pink-200 bg-[#24151d] p-5 text-pink-50 shadow-[0_35px_110px_rgba(219,39,119,0.28)]">
            <div className="mb-8 flex items-center justify-between">
              ...
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-pink-400 text-white shadow-[0_16px_40px_rgba(244,114,182,0.45)]">
                <svg
